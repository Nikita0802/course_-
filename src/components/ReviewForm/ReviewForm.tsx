...
export const ReviewForm = ({ isOpened, producktId, className, ...props }: ReviewFormProps): JSX.Element => {
	...
	return (
		<form onSubmit={handleSubmit(onSubmit)}>
			...
			{isSucces && <div className={cn(styles.success, styles.panel)} role='alert'>
